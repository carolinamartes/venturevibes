...
export const Hero = () => {
  ...
  return (
    <section className="pt-32 pb-24 px-6 relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-indigo-50/30">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-4 relative">
            {!showCTA ? (
              ...
              >
                <span>Join Pre-Launch Waitlist</span>
              </button>
            ) : (
            ...
            {showCTA && (
              <div className="absolute top-0 left-0 z-10 w-[320px] sm:w-[400px] glassmorphism p-6 rounded-xl shadow-lg animate-scaleIn">
      ...
      <div className="max-w-7xl mx-auto mt-28 px-6" id="how-it-works">
        <div className="text-center mb-16 reveal reveal-up">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Your Journey to a Successful Launch</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-soft text-center relative reveal reveal-left hover-lift transition-standard">
            ...
            <h3 className="text-lg font-bold mb-2">Define Your Project</h3>
            <p className="text-slate-600">Tell us about your idea and goals, and our AI will validate your concept and analyze your project's specific needs</p>
          </div>
          
          <div className="bg-white p-6 rounded-xl shadow-soft text-center relative reveal reveal-up hover-lift transition-standard delay-100">
            ...
            <h3 className="text-lg font-bold mb-2">Get Your AI Toolkit & Roadmap</h3>
            <p className="text-slate-600">Receive personalized AI tool recommendations and a structured roadmap for your launch</p>
          </div>
          
          <div className="bg-white p-6 rounded-xl shadow-soft text-center relative reveal reveal-right hover-lift transition-standard delay-200">
            ...
            <p className="text-slate-600">Access our curated library of no-code solutions covering the entire tech product lifecycle, from ideation to launch and growth</p>
          </div>
        </div>
      </div>
    </section>
